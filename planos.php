                ...
                <head>                   
                    ...
                    <script>
                        ...
                        function comprar(usuario, id, tipo) {
                            if (usuario === 'Usuario') {
                                ...
                                <?php while ($row = $result_planos->fetch_assoc()): ?>
                                    <div class="col-md-4 mb-4">
                                        <div class="card plano p-3">
                                            ...
                                            <a href="#" class="cta-button btn btn-success" onclick="comprar('<?php echo $usuario; ?>', <?php echo $row['id_planos']; ?>, 'plano')">Comprar</a>
                                        </div>
                                    </div>
                                <?php endwhile; ?>
                            <?php else: ?>
                                ...
                                <?php while ($row = $result_departamentos->fetch_assoc()): ?>
                                    <div class="col-md-4 mb-4">
                                        <div class="card departamento p-3">
                                            ...
                                            <a href="#" class="cta-button btn btn-success" onclick="comprar('<?php echo $usuario; ?>', <?php echo $row['id_departamento']; ?>, 'departamento')">Comprar</a>
                                        </div>
                                    </div>
                                <?php endwhile; ?>
                            <?php else: ?>
                                ...
                                <?php while ($row = $result_condominios->fetch_assoc()): ?>
                                    <div class="col-md-4 mb-4">
                                        <div class="card condominio p-3">
                                            ...
                                            <a href="#" class="cta-button btn btn-success" onclick="comprar('<?php echo $usuario; ?>', <?php echo $row['id_condominio']; ?>, 'condominio')">Comprar</a>
                                        </div>
                                    </div>
                                <?php endwhile; ?>
                            <?php else: ?>
